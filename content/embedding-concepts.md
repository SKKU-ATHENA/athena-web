...
두 벡터가 같은 방향을 가리킬수록 1에 가깝고, 반대면 -1에 가깝다.
...
임베딩은 고차원 공간의 한 점이다. 의미가 비슷한 텍스트는 이 공간에서 **가까이** 위치한다. x,y 좌표가 2차원이듯, 384개의 숫자가 384차원이다. 더 많은 차원 = 더 풍부한 의미 표현.
